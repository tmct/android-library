...
import com.tealium.mobile.android.TealiumTagger;
...
public class NoteEditor extends Activity {
	...
	private int mState;
	private final boolean mNoteOnly = false;
	private Uri mUri;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		staticTealiumVariables.put("myCustomVar1", "value1");
		staticTealiumVariables.put("myCustomVar2", "value2");
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		Map<String, String> overrideVars = new HashMap<String, String>();
		overrideVars.put("myCustomVar1", "overriddenValue1");
		overrideVars.put("myAdditionalCustomVar3", "additionalValue3");
		tealium.trackItemClicked(item.getTitle().toString(), overrideVars);
	...
	private final void cancelNote() {
		tealium.trackCustomEvent("cancelled note", null);
	...
	private final void deleteNote() {
		tealium.trackCustomEvent("deleted note", null);
